...
function PageShell({ label, title, meta, children }) {
  return (
    <div className="grain min-h-screen">
      <div className="relative z-10 max-w-[1180px] mx-auto px-8 py-6">
...
function Th({ children, align = 'left' }) {
  return (
    <th
      className={`label py-2.5 px-3 font-normal text-${align} border-b hairline`}
    >
      {children}
    </th>
  )
            ...
            {rows.map((r, i) => (
              ...
              >
                ...
                <Td
                  ...
                  mono
                  className={
                    r.days_overdue > 120 ? 'text-alertText' : 'text-accent'
                  }
                >
                  {r.days_overdue}d
                </Td>
